								...
								<div class="row">
									<div class="col-md-2">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="usuario_identificacion" name="usuario_identificacion">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
									...
									<div class="col-md-2">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="usuario_movil" name="usuario_movil">
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<label for="usuario_sede">Sede</label>
											<input type="text" class="form-control" id="usuario_sede" name="usuario_sede" >
										</div>
									</div>									
								</div>

...
<?php 
  ...
  $insGenerar = new menuController();	
    ...
    $nombre= ($_SESSION['sede'] != "") ? 'Julio Villavicencio '.$_SESSION['sede'] : "Julio Villavicencio";
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?php echo APP_URL; ?>app/views/dist/img/Logos/logo.png" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">

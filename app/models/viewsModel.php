	...
	class viewsModel{
		...
		protected function obtenerVistasModelo($vista){
			$listaBlanca=["dashboard","userNew","userList","userUpdate","userSearch","userPhoto"
						  ,"logOut","roList","escuelaNew","afiliadoList","afiliadoNew","afiliadoUpdate"
						  ,"pagos","userProfile","escuelaNew","sedeList","sedeNew","sedeProfile"
						  ,"sedeUpdate","pagosList","pagosNew","afiliadoProfile","pagosUpdate"
						  ...
						  ,"reporteRubros","reportePagosReceptadosResumen","afiliadoListaPDF","ingresoList"
